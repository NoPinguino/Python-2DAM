...
match(fig):
    ...
    case 2:
        ...
        print(f"Perímetro: {lado1 * lado2}cm")
        print(f"Área: {(lado1 * 2) * (lado2 * 2)}cm2")
    case 3:
    ...
    case 5:
        apot = int(input("Introduce la apotema: "))
        lado = int(input("Introduce el lado: "))
        perim = lado * 5

        print(f"Perímetro: {perim}cm")
        print(f"Área: {(perim * apot) / 2}cm2")
    case 6:
        apot = int(input("Introduce la apotema: "))
        lado = int(input("Introduce el lado: "))
        perim = lado * 6
